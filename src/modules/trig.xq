...
import module namespace mq = "https://metadatafram.es/metaquery/mq/"
at "mq.xqm";

import module namespace trig = "http://basex.org/modules/rdf/trig";
...
trig:parse(
  ``[
    <http://id.loc.gov/authorities/names/n50034916> a bf:Agent,
        bf:Person ;
    rdfs:label "Gutenberg, Johann, 1397?-1468," ;
    bflc:name00MarcKey "7001 $aGutenberg, Johann,$d1397?-1468,$eprinter." ;
    bflc:name00MatchKey "Gutenberg, Johann, 1397?-1468," .
...
<http://id.loc.gov/authorities/names/n00020514> a bf:Title ;
    ...
    bflc:title30MarcKey "1300 $aBible.$lLatin.$sVulgate.$f1454." ;
    bflc:title30MatchKey "Bible. Vulgate. 1454." ;
    bflc:titleSortKey "Bible. Vulgate. 1454." ;
    bf:mainTitle "Bible" .
...
<https://metadatafram.es/3391099#Instance> a bf:Instance ;
    ...
    bf:note [ a bf:Note ;
            rdfs:label "Commonly known as the Gutenberg Bible." ] ;
    ...
    bf:provisionActivityStatement "[Mainz : Johann Gutenberg, ca. 1454]" ;
    bf:title [ a bf:Title ;
            rdfs:label "Biblia latina." ;
...
<https://metadatafram.es/3391099#Item856-33> a bf:Item ;
    bf:electronicLocator [ a rdfs:Resource ;
            ...
            bf:note [ a bf:Note ;
                    rdfs:label "View a selection of digital images in the Beinecke Library's Digital Images Online database" ] ] ;
...
<http://id.loc.gov/authorities/names/n82109028> a bf:Title ;
    rdfs:label "Bible. Latin. Vulgate. 1454.",
        "Gutenberg Bible." ;
    bflc:title30MarcKey "1300 $aBible.$lLatin.$sVulgate.$f1454." ;
    bflc:title30MatchKey "Bible. Latin. Vulgate. 1454." ;
    bflc:titleSortKey "Bible. Latin. Vulgate. 1454.",
        "Gutenberg Bible." ;
    bf:mainTitle "Bible",
        "Gutenberg Bible" .
...
<https://metadatafram.es/3391099#Work> a bf:Text,
    ...
    bf:adminMetadata [ a bf:AdminMetadata ;
            ...
            bf:generationProcess [ a bf:GenerationProcess ;
                    rdfs:label "DLC marc2bibframe2 v1.4.0-SNAPSHOT: 2017-10-18T02:37:09Z" ] ;
            bf:identifiedBy [ a bf:Local ;
